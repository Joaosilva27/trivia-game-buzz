    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-800 to-slate-900">
      <div className="w-full max-w-lg px-8 py-10 text-center">
        <h1 className="mb-6 text-4xl font-bold text-white">
          BUZZ!
          <span className="block mt-2 text-2xl font-medium text-amber-400">
            TRIVIA GAME
          </span>
        </h1>
        ...
        <div className="relative mb-8">
          ...
          <img
            src={LayingBuzzImage}
            alt="Buzz Character"
            className="relative z-10 mx-auto h-80"
          />
        </div>
        ...
        <a href="https://www.joaoportfolio.com" target="_blank">
          <div className="flex justify-center items-center mt-6">
            <p className=" text-sm underline text-slate-400">
              Built and designed by João Silva
            </p>
            <img
              src={GithubIcon}
              className="w-4 object-scale-down ml-1.5 animate-bounce"
            />
          </div>
        </a>
      </div>
